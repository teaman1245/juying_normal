			...
			<aside class="col-md-3 col-sm-4 col-xs-12 content-aside left_column " id="column-left">
				<div class="module blog-category titleLine">
                	...
                	<div class="modcontent">
                		<ul class="list-group ">
                			<li class="list-group-item"> <a href="blog-page.jsp"class="group-item active">Our Blog</a></li>
                			<li class="list-group-item"><a href="blog-page.jsp" class="group-item">Demo Category 2</a></li>
                			<li class="list-group-item"><a href="blog-page.jsp" class="group-item">Demo Category 3</a></li>
                			<li class="list-group-item"><a href="blog-page.jsp" class="group-item">Demo Category 4</a></li>
                			<li class="list-group-item"><a href="blog-page.jsp" class="group-item">Demo Category 5</a></li>
                		</ul>
                                ...
                                <div class="itemBlogContent clearfix ">
                                    <div class="blog-content">
                                        <div class="article-title font-title">
                                            <h4><a href="http://demo.smartaddons.com/templates/html/supermarket/blog-detail.jsp">Duis autem vel eum irure sed diam nonumy</a></h4>
                                        </div>
                                        ...
                                        <div class="readmore">  <a class="btn-readmore font-title" href="http://demo.smartaddons.com/templates/html/supermarket/blog-detail.jsp"><i class="fa fa-caret-right"></i>Read More</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="blog-item col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="blog-item-inner clearfix">
                                ...
                                <div class="itemBlogContent clearfix ">
                                    <div class="blog-content">
                                        <div class="article-title font-title">
                                            <h4><a href="http://demo.smartaddons.com/templates/html/supermarket/blog-detail.jsp">Biten demons lector in henderit in vulp</a></h4>
                                        </div>
                                        <div class="blog-meta"> <span class="author"><i class="fa fa-user"></i><span>Post by </span>Wash upito</span>
                                        </div>
                        ...
                        <div class="blog-item col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="blog-item-inner clearfix">
                                ...
                                <div class="itemBlogContent clearfix ">
                                    <div class="blog-content">
                                        <div class="article-title font-title">
                                            <h4><a href="http://demo.smartaddons.com/templates/html/supermarket/blog-detail.jsp">Duis autem vel eum tempor invidunt ut labore et </a></h4>
                                        </div>
                        ...
                        <div class="blog-item col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="blog-item-inner clearfix">
                                ...
                                <div class="itemBlogContent clearfix ">
                                    <div class="blog-content">
                                        <div class="article-title font-title">
                                            <h4><a href="http://demo.smartaddons.com/templates/html/supermarket/blog-detail.jsp">Enim ad minim veniam  justo duo dolores et ea</a></h4>
                                        </div>
                        ...
                        <div class="blog-item col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="blog-item-inner clearfix">
                                ...
                                <div class="itemBlogContent clearfix ">
                                    <div class="blog-content">
                                        <div class="article-title font-title">
                                            <h4><a href="http://demo.smartaddons.com/templates/html/supermarket/blog-detail.jsp">Kire tuma feugiat </a></h4>
                                        </div>
                                        <div class="blog-meta"> <span class="author"><i class="fa fa-user"></i><span>Post by </span>Wash upito</span>
                                        </div>
                                        <p class="article-description">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lore...</p>
                        ...
                        <div class="blog-item col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="blog-item-inner clearfix">
                                ...
                                <div class="itemBlogContent clearfix ">
                                    <div class="blog-content">
                                        <div class="article-title font-title">
                                            <h4><a href="http://demo.smartaddons.com/templates/html/supermarket/blog-detail.jsp">Lorem ipsum dolor sit amet</a></h4>
                                        </div>
                                        <div class="blog-meta"> <span class="author"><i class="fa fa-user"></i><span>Post by </span>Wash upito</span>   <span class="comment_count"><i class="fa fa-comment-o"></i><a href="#">0 Comments</a></span>
                                        </div>
                                        <p class="article-description">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lore...</p>
                        ...
                        <div class="blog-item col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="blog-item-inner clearfix">
                                ...
                                <div class="itemBlogContent clearfix ">
                                    <div class="blog-content">
                                        <div class="article-title font-title">
                                            <h4><a href="http://demo.smartaddons.com/templates/html/supermarket/blog-detail.jsp">Commodo laoreet semper tincidun   sit</a></h4>
                                        </div>
                                        <div class="blog-meta"> <span class="author"><i class="fa fa-user"></i><span>Post by </span>Wash upito</span>
                                        </div>
                                        <p class="article-description">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lore...</p>
                        ...
                        <div class="blog-item col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="blog-item-inner clearfix">
                                ...
                                <div class="itemBlogContent clearfix ">
                                    <div class="blog-content">
                                        <div class="article-title font-title">
                                            <h4><a href="http://demo.smartaddons.com/templates/html/supermarket/blog-detail.jsp">Kire tuma demons vel eum iriure dolor</a></h4>
                                        </div>
                                        <div class="blog-meta"> <span class="author"><i class="fa fa-user"></i><span>Post by </span>Wash upito</span>
                                        </div>
                                        <p class="article-description">Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Lorem ipsum dolor sit amet, c...</p>
