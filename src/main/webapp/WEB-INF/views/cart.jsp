...
<body class="res layout-1">
	...
	<div class="main-container container">
          ...
          <h2 class="title">Shopping Cart</h2>
            <div class="table-responsive form-group">
              <table class="table table-bordered">
                ...
                <tbody>
                  <tr>
                    <td class="text-center"><a href="product.jsp"><img width="70px" src="image/catalog/demo/product/fashion/8.jpg" alt="Aspire Ultrabook Laptop" title="Aspire Ultrabook Laptop" class="img-thumbnail" /></a></td>
                    <td class="text-left"><a href="product.jsp">Emasa rumas gacem</a><br />
                     </td>
                  ...
                  <tr>
                    <td class="text-center"><a href="product.jsp"><img width="70px" src="image/catalog/demo/product/fashion/10.jpg" alt="Xitefun Causal Wear Fancy Shoes" title="Xitefun Causal Wear Fancy Shoes" class="img-thumbnail" /></a></td>
                    <td class="text-left"><a href="product.jsp">Comas samer rumas</a></td>
                    <td class="text-left">Pt 002</td>
                    <td class="text-left" width="200px"><div class="input-group btn-block quantity">
                        <input type="text" name="quantity" value="1" size="1" class="form-control" />
                        <span class="input-group-btn">
                        <button type="submit" data-toggle="tooltip" title="Update" class="btn btn-primary"><i class="a fa-clone"></i></button>
                        <button type="button" data-toggle="tooltip" title="Remove" class="btn btn-danger" onClick=""><i class="fa fa-times-circle"></i></button>
                        </span></div></td>
		...
		<div class="row">
		 ...
		 <div class="buttons">
            <div class="pull-left"><a href="index.jsp" class="btn btn-primary">Continue Shopping</a></div>
            <div class="pull-right"><a href="checkout.jsp" class="btn btn-primary">Checkout</a></div>
          </div>
        </div>
        <!--Middle Part End -->
