                	...
                	<div class="modcontent">
                		<div class="box-category">
                			<ul id="cat_accordion" class="list-group">
                				<li class="hadchild"><a href="category.jsp" class="cutom-parent">Smartphone & Tablets</a>   <span class="button-view  fa fa-plus-square-o"></span>
                				...
                				<li class="hadchild"><a class="cutom-parent" href="category.jsp">Electronics</a>   <span class="button-view  fa fa-plus-square-o"></span>
                				...
                				<li class="hadchild"><a href="category.jsp" class="cutom-parent">Shoes</a>   <span class="button-view  fa fa-plus-square-o"></span>
                					<ul style="display: none;">
                						<li><a href="category.jsp">Sub Categories</a></li>
                						<li><a href="category.jsp">Sub Categories</a></li>
                						<li><a href="category.jsp">Sub Categories</a></li>
                						<li><a href="category.jsp">Sub Categories</a></li>
                						<li><a href="category.jsp">Sub Categories</a></li>
                				...
                				<li class="hadchild"><a href="category.jsp" class="cutom-parent">Watches</a>  <span class="button-view  fa fa-plus-square-o"></span>
                					<ul style="display: none;">
                						<li><a href="category.jsp">Men's Watches</a></li>
                						<li><a href="category.jsp">Women's Watches</a></li>
                						<li><a href="category.jsp">Kids' Watches</a></li>
                				...
                				<li class="hadchild"><a href="category.jsp" class="cutom-parent">Jewellery</a>    <span class="button-view  fa fa-plus-square-o"></span>
                					<ul style="display: none;">
                						<li><a href="category.jsp">Sub Categories</a></li>
                						<li><a href="category.jsp">Sub Categories</a></li>
                						<li><a href="category.jsp">Sub Categories</a></li>
                				...
                				<li class=""><a href="category.jsp" class="cutom-parent">Health &amp; Beauty</a>  <span class="dcjq-icon"></span></li>
                				<li class=""><a href="category.jsp" class="cutom-parent">Kids &amp; Babies</a>    <span class="dcjq-icon"></span></li>
                				<li class=""><a href="category.jsp" class="cutom-parent">Sports</a>  <span class="dcjq-icon"></span></li>
                				<li class=""><a href="category.jsp" class="cutom-parent">Home &amp; Garden</a><span class="dcjq-icon"></span></li>
                				<li class=""><a href="category.jsp" class="cutom-parent">Wines &amp; Spirits</a>  <span class="dcjq-icon"></span></li>
                			</ul>
                		</div>
                            ...
                            <div class="product-item-container">
                                ...
                                <div class="right-block">
                                    ...
                                    <div class="list-block">
                                        ...
                                        <!--quickview-->                                                      
                                        <a class="iframe-link btn-button quickview quickview_handler visible-lg" href="quickview.jsp" title="Quick view" data-fancybox-type="iframe"><i class="fa fa-eye"></i></a>                                                        
                                        <!--end quickview-->
                                    </div>
                                </div>
