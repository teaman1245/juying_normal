                                ...
                                <div class="btn-group languages-block ">
                                    <form action="index.jsp" method="post" enctype="multipart/form-data" id="bt-language">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li> <a href="http://demo.smartaddons.com/templates/html/supermarket/html_with_RTL/home3.jsp"> <img class="image_flag" src="image/catalog/flags/ar.png" alt="Arabic" title="Arabic" /> Arabic </a> </li>
                                        </ul>
                                    </form>
                                </div>
                    ...
                    <div class="header-top-right collapsed-block col-lg-4 col-md-7 col-sm-6 col-xs-5">
                        <div class="inner">  
                            <ul class="top-link list-inline">
                                ...
                                <li class="wishlist hidden-xs"><a href="#" id="wishlist-total" class="top-link-wishlist" title="Wish List (0) "><span>Wish List (0)</span></a></li>  
                                <li class="checkout hidden-sm hidden-xs"><a href="#" title="Checkout "><span>Checkout</span></a></li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="navbar-logo col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        <div class="logo"><a href="http://demo.smartaddons.com/templates/html/supermarket/index.php"><img src="image/catalog/logo3.png" title="Your Store" alt="Your Store" /></a></div>
                    </div>
                    <!-- //end Logo -->
                    <!-- Search -->
                    ...
                    <div class="middle3 col-lg-4 col-md-3 col-sm-6 col-xs-6"> 
                        ...
                        <ul class="login-w hidden-md hidden-sm hidden-xs">
                            <li>My Account</li>
                            <li class="logout"><a href="login.jsp">Login</a> / <a href="register.jsp">Register</a></li>                            
                        </ul>                       
                    </div>    
                </div>
                                        ...
                                        <div class="megamenu-pattern">
                                            <div class="container-mega">
                                                <ul class="megamenu" data-transition="slide" data-animationtime="250">
                                                    <li class="home hover">
                                                        <a href="http://demo.smartaddons.com/templates/html/supermarket/index.php">Home <b class="caret"></b></a>
    ...
    <div id="content">
        <div class="container">
            ...
            <div class="banners1 banners">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <a href="#"><img src="image/catalog/banners/id3-bn1.jpg" alt="image"></a>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <a href="#"><img src="image/catalog/banners/id3-bn2.jpg" alt="image"></a>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <a href="#"><img src="image/catalog/banners/id3-bn3.jpg" alt="image"></a>
                    </div>
                </div>
            </div>
            ...
            <div class="module listingtab-layout1">
                ...
                <div id="so_listing_tabs_1" class="so-listing-tabs first-load">
                    ...
                    <div class="ltabs-wrap">
                        <div class="ltabs-tabs-container" data-delay="300" data-duration="600" data-effect="starwars" data-ajaxurl="" data-type_source="0" data-lg="5" data-md="4" data-sm="3" data-xs="1" data-margin="30">
                            <!--Begin Tabs-->
                        ...
                        <div class="ltabs-items-container products-list grid">
                            <a class="items-category-seeall viewall" href="#" title="View all"> View all <i class="fa fa-caret-right"></i></a>
                            <!--Begin Items-->
                                            ...
                                            <div class="product-item-container">
                                                <div class="left-block left-b">
                                                    ...
                                                    <div class="so-quickview">
                                                      <a class="iframe-link btn-button quickview quickview_handler visible-lg" href="quickview.jsp" title="Quick view" data-fancybox-type="iframe"><i class="fa fa-eye"></i><span>Quick view</span></a>
                                                    </div>                                                     
                                                    <!--end quickview-->
            ...
            <div class="block-policy1">
              <ul class="row">
                <li class="item-1 col-lg-3 col-md-3 col-sm-6 col-xs-12">
                ...
                <li class="item-2 col-lg-3 col-md-3 col-sm-6 col-xs-12">
                  <a href="#" class="item-inner">       
                      <div class="content">
                        <b>Money Guarantee</b>
                ...
                <li class="item-3 col-lg-3 col-md-3 col-sm-6 col-xs-12">
                  <a href="#" class="item-inner">       
                    <div class="content">
                      <b>Payment Method</b>
                ...
                <li class="item-4 col-lg-3 col-md-3 col-sm-6 col-xs-12">
                  <a href="#" class="item-inner">       
                    <div class="content">
                      <b>Online Support</b>
            ...
            <!-- Content deal, banner -->
            <div class="row">
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 col-style">
                                ...
                                <div class="deals-content products-list">
                                    <div class="slider slider-for ds-items-detail">
                                        <div class="slick-slide product-layout item">
                                            <div class="product-thumb">
                                                <div class="image">
                                                    ...
                                                    <div class="inner">
                                                        <a href="#"><img src="image/catalog/demo/product/fashion/1.jpg" alt="img1"></a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="caption">
                                                    ...
                                                    <p class="desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco labori..</p>
                                                    <div class="item-available">
                                                        <div class="row">
                                                            <p class="col-xs-6 a1">Available: <b>64</b> </p>
                                                            <p class="col-xs-6 a2">Sold: <b>36</b>  </p>
                                                        </div>
                                                        <div class="available">
                                                            <span class="color_width" data-title="36%" data-toggle="tooltip" style="width: 36%" data-original-title="" title=""></span>
                                                        </div>
                                                    </div>
                                                    <div class="item-time-w">
                                                        <div class="time-title"><span>Hurry Up!</span> Offer ends in:</div>
                                                        <div class="item-timee">
                                        ...
                                        <div class="slick-slide">
                                            <div class="product-thumb">
                                                <div class="image">
                                                    <span class="label-product label-product-sale">-20%</span>
                                                    <div class="inner">
                                                        <a href="#"><img src="image/catalog/demo/product/fashion/2.jpg" alt="img2"></a>
                                                    </div>
                                                </div>

                                                <div class="caption">
                                                    <h4><a href="#" target="_self" title="Srehenderit dolore">Srehenderit dolore</a></h4>
                                                    <div class="rating">
                                                        <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                                                        <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                                                        <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                                                    ...
                                                    <div class="item-available">
                                                        ...
                                                        <div class="available">
                                                            <span class="color_width" data-title="60%" data-toggle="tooltip" style="width: 60%" data-original-title="" title=""></span>
                                                        </div>
                                                    </div>
                                                    <div class="item-time-w">
                                                        <div class="time-title"><span>Hurry Up!</span> Offer ends in:</div>
                                        ...
                                        <div class="slick-slide">
                                             <div class="product-thumb">
                                                <div class="image">
                                                    <span class="label-product label-product-sale">-20%</span>
                                                    <div class="inner">
                                                        <a href="#"><img src="image/catalog/demo/product/fashion/3.jpg" alt="img3"></a>
                                                    </div>
                                                </div>

                                                <div class="caption">
                                                    <h4><a href="#" target="_self" title="Lorem ipsum dolor">Lorem ipsum dolor</a></h4>
                                                    <div class="rating">
                                                        <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                                                        <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                                                        <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                                        ...
                                        <div class="slick-slide">
                                          <div class="product-thumb">
                                                <div class="image">
                                                    <span class="label-product label-product-sale">-20%</span>
                                                    <div class="inner">
                                                        <a href="#"><img src="image/catalog/demo/product/fashion/4.jpg" alt="img4"></a>
                                                    </div>
                                                </div>

                                                <div class="caption">
                                                    <h4><a href="#" target="_self" title="Quis nostrud exer">Quis nostrud exer</a></h4>
                                                    <div class="rating">
                                                        <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                                                        <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                                                        <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                                        ...
                                        <div class="slick-slide">
                                            <div class="product-thumb">
                                                <div class="image">
                                                    <span class="label-product label-product-sale">-20%</span>
                                                    <div class="inner">
                                                        <a href="#"><img src="image/catalog/demo/product/fashion/5.jpg" alt="img5"></a>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="slick-slide">
                                            <div class="product-thumb">
                                                <div class="image">
                                                    <span class="label-product label-product-sale">-20%</span>
                                                    <div class="inner">
                                                        <a href="#"><img src="image/catalog/demo/product/fashion/6.jpg" alt="img6"></a>
                                                    </div>
                                                </div>

                                                <div class="caption">
                                                    <h4><a href="#" target="_self" title="Ut enim ad minim">Ut enim ad minim</a></h4>
                                                    <div class="rating">
                                                        <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                                                        <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                                                        <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                                        ...
                                        <div class="slick-slide">
                                            <div class="product-thumb">
                                                <div class="image">
                                                    <span class="label-product label-product-sale">-20%</span>
                                                    <div class="inner">
                                                        <a href="#"><img src="image/catalog/demo/product/fashion/7.jpg" alt="img7"></a>
                                                    </div>
                                                </div>

                                                <div class="caption">
                                                    <h4><a href="#" target="_self" title="Sed do eiusmod">Sed do eiusmod</a></h4>
                                                    <div class="rating">
                                                        <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                                                        <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                                                        <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                                        ...
                                        <div class="slick-slide">
                                            <div class="product-thumb">
                                                <div class="image">
                                                    <span class="label-product label-product-sale">-20%</span>
                                                    <div class="inner">
                                                        <a href="#"><img src="image/catalog/demo/product/fashion/8.jpg" alt="img8"></a>
                                                    </div>
                                                </div>

                                                <div class="caption">
                                                    <h4><a href="#" target="_self" title="Consectetur adipisicing">Consectetur adipisicing</a></h4>
                                                    <div class="rating">
                                                        <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                                                        <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                                                        <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                                        ...
                                        <div class="slick-slide">
                                            <div class="product-thumb">
                                                <div class="image">
                                                    <span class="label-product label-product-sale">-20%</span>
                                                    <div class="inner">
                                                        <a href="#"><img src="image/catalog/demo/product/fashion/9.jpg" alt="img9"></a>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="slick-slide ds-item">
                                            <div class="ds-item-inner">
                                                <div class="ds-image-thumb">
                                                    <img src="image/catalog/demo/product/fashion/1.jpg" alt="img1">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="slick-slide ds-item">
                                            <div class="ds-item-inner">
                                                <div class="ds-image-thumb">
                                                    <img src="image/catalog/demo/product/fashion/2.jpg" alt="img2">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="slick-slide ds-item">
                                            <div class="ds-item-inner">
                                                <div class="ds-image-thumb">
                                                    <img src="image/catalog/demo/product/fashion/3.jpg" alt="img3">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="slick-slide ds-item">
                                            <div class="ds-item-inner">
                                                <div class="ds-image-thumb">
                                                    <img src="image/catalog/demo/product/fashion/4.jpg" alt="img4">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="slick-slide ds-item">
                                            <div class="ds-item-inner">
                                                <div class="ds-image-thumb">
                                                    <img src="image/catalog/demo/product/fashion/5.jpg" alt="img5">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="slick-slide ds-item">
                                            <div class="ds-item-inner">
                                                <div class="ds-image-thumb">
                                                    <img src="image/catalog/demo/product/fashion/6.jpg" alt="img6">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="slick-slide ds-item">
                                            <div class="ds-item-inner">
                                                <div class="ds-image-thumb">
                                                    <img src="image/catalog/demo/product/fashion/7.jpg" alt="img71">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="slick-slide ds-item">
                                            <div class="ds-item-inner">
                                                <div class="ds-image-thumb">
                                                    <img src="image/catalog/demo/product/fashion/8.jpg" alt="img8">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="slick-slide ds-item">
                                            <div class="ds-item-inner">
                                                <div class="ds-image-thumb">
                                                    <img src="image/catalog/demo/product/fashion/9.jpg" alt="img9">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 hidden-sm hidden-xs">
                    <div class="banners2 banners">
                      <div><a href="#"><img src="image/catalog/banners/id3-bn4.jpg" alt="image"></a></div>
                    </div>
                </div>
            </div>
            <!-- end Content deal, banner -->
            ...
            <div class="row">
                <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                    <div class="banners3 banners">
                        <div class="item1">
                            <a href="#"><img src="image/catalog/banners/id3-bn5.jpg" alt="image"></a>
                        </div>
                        <div class="item2">
                            <a href="#"><img src="image/catalog/banners/id3-bn6.jpg" alt="image"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 hidden-md hidden-xs hidden-sm">
                    <div class="banners4 banners">
                        <div class="item1">
                            <a href="#"><img src="image/catalog/banners/id3-bn7.jpg" alt="image"></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col_nn6i  col-style">
                <div id="so_categories_45651530697557" class="so-categories module theme3 custom-slidercates preset01-4 preset02-4 preset03-3 preset04-2 preset05-1">
                    ...
                    <div class="modcontent">              
                        <div class="cat-wrap theme3 yt-content-slider cat-wrap" data-rtl="yes" data-autoplay="no" data-autoheight="no" data-delay="4" data-speed="0.6" data-margin="30" data-items_column00="4" data-items_column0="4" data-items_column1="4" data-items_column2="3"  data-items_column3="2" data-items_column4="1" data-arrows="yes" data-pagination="no" data-lazyload="yes" data-loop="yes" data-hoverpause="yes">
                            <div class="content-box">
                                ...
                                <div class="child-cat">
                                    <div class="child-cat-title"><a href="#">Toshiba</a></div>
                                    <div class="child-cat-title"><a href="#">Dell</a></div>
                                    <div class="child-cat-title"><a href="#">Esdipiscing</a></div>
                                    <div class="child-cat-title"><a href="#">Apple</a></div>

                                    <a href="#" class="viewmore" title="Electronics"> More Categories </a>
                                </div>     
                            </div>

                            <div class="content-box">
                                <div class="image-cat">
                                  <a href="#" title="Furnicom">
                                ...
                                <div class="child-cat">
                                    <div class="child-cat-title"><a href="#">Lorem ipsum</a></div>
                                    <div class="child-cat-title"><a href="#">Consectetur </a></div>
                                    <div class="child-cat-title"><a href="#">Esdipiscing</a></div>
                                    <div class="child-cat-title"><a href="#">Incididunt</a></div>

                                    <a href="#" class="viewmore" title="Furnicom"> More Categories </a>
                                </div>     
                            </div>
                            ...
                            <div class="content-box">
                                ...
                                <div class="child-cat">
                                    <div class="child-cat-title"><a href="#">Doloremque</a></div>
                                    <div class="child-cat-title"><a href="#">Excepteur </a></div>
                                    <div class="child-cat-title"><a href="#">Mollit anim</a></div>
                                    <div class="child-cat-title"><a href="#">Accusantium</a></div>

                                    <a href="#" class="viewmore" title="Iwatch & Accessories"> More Categories </a>
                                </div>     
                            </div>
                            ...
                            <div class="content-box">
                                ...
                                <div class="child-cat">
                                    ...
                                    <a href="#" class="viewmore" title="Fashion"> More Categories </a>
                                </div>     
                            </div>

                            <div class="content-box">
                                <div class="image-cat">
                                  <a href="#" title="Health & Beauty">
                                ...
                                <div class="child-cat">
                                    <div class="child-cat-title"><a href="#">Excepteur</a></div>
                                    <div class="child-cat-title"><a href="#">Jeans</a></div>
                                    <div class="child-cat-title"><a href="#">Esdipiscing</a></div>
                                    <div class="child-cat-title"><a href="#">Lorem isspum</a></div>

                                    <a href="#" class="viewmore" title="Health & Beauty"> More Categories </a>
                                </div>     
                            </div>
            ...
            <div class="banners5 banners">
              <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <a href="#"><img src="image/catalog/banners/id3-bn8.jpg" alt="image"></a>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <a href="#"><img src="image/catalog/banners/id3-bn9.jpg" alt="image"></a>
                </div>
              </div>
            </div>

            <!-- Category slider -->
            <div id="so_category_slider_193" class="so-category-slider container-slider module so-category-slider-ltr cate-slider3">
                                    ...
                                    <div class="item ">
                                        ...
                                        <div class="product-layout item-inner style1 ">
                                            <div class="item-image">
                                                <div class="item-img-info">
                                                    <a href="#" target="_self" title="Consecte quichuck ">
                                                    <img src="image/catalog/demo/product/80/4.jpg" alt="Consecte quichuck">
                                                    </a>
                                                </div>
                                    ...
                                    <div class="item ">
                                        <div class="product-layout item-inner style1 ">
                                            <div class="item-image">
                                                <div class="item-img-info">
                                                    <a href="#" target="_self" title="Mandouille short ">
                                                        <img src="image/catalog/demo/product/80/12.jpg" alt="Mandouille short">
                                                        </a>
                                                </div>
                                        ...
                                        <div class="product-layout item-inner style1 ">
                                            <div class="item-image">
                                                <div class="item-img-info">
                                                    <a href="#" target="_self" title="Xancetta bresao ">
                                                            <img src="image/catalog/demo/product/80/11.jpg" alt="Xancetta bresao">
                                                            </a>
                                                </div>
                                        ...
                                        <div class="product-layout item-inner style1 ">
                                            <div class="item-image">
                                                <div class="item-img-info">
                                                    <a href="#" target="_self" title="Sausage cowbee ">
                                                                <img src="image/catalog/demo/product/80/10.jpg" alt="Sausage cowbee">
                                                                </a>
                                                </div>
                                    ...
                                    <div class="item ">
                                        ...
                                        <div class="product-layout item-inner style1 ">
                                            <div class="item-image">
                                                <div class="item-img-info">
                                                    <a href="#" target="_self" title="Consecte quichuck ">
                                                    <img src="image/catalog/demo/product/80/1.jpg" alt="Consecte quichuck">
                                                    </a>
                                                </div>
            ...
            <div class="row row_10fp  row-bb ">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col_0hlj  col-style">
                    <div class="livechat">
                        <a href="#"><img src="image/catalog/banners/id3-livechat.jpg" alt="image"></a>
                    </div>
                </div>          
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col_ktny  col-style">
                    <div class="socials-w">
...
<!-- //Main Container -->
    ...
    <footer class="footer-container typefooter-3">
        ...
        <section class="footer-middle ">
            ...
            <div class="container">
                <div class="row apps-w ">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-style">
                        <div class="app-store module">
                            <h3 class="modtitle">Download APP:</h3>
                            <ul>
                                <li><a title="App Store" href="#"><img src="image/catalog/demo/payment/app-3.png" alt="App Store"></a></li>
                                <li><a title="App Store" href="#"><img src="image/catalog/demo/payment/app-4.png" alt="App Store"></a></li>
                            </ul>
                        </div>
                    </div>          
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-style">
                        <div class="payment"><a title="App Store" href="#"><img src="image/catalog/demo/payment/payment3.png" alt="App Store"></a></div>
                    </div>          
                </div>
