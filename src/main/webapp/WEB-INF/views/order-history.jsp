						...
						<tbody>
							<tr>
								<td class="text-center">
									<a href="product.jsp"><img width="85" class="img-thumbnail" title="Aspire Ultrabook Laptop" alt="Aspire Ultrabook Laptop" src="image/catalog/demo/product/fashion/1.jpg">
									</a>
								</td>
								<td class="text-left"><a href="product.jsp">Aspire Ultrabook Laptop</a>
								</td>
								...
								<td class="text-center"><a class="btn btn-info" title="" data-toggle="tooltip" href="order-information.jsp" data-original-title="View"><i class="fa fa-eye"></i></a>
								</td>
							</tr>
							<tr>
								<td class="text-center">
									<a href="product.jsp"><img  width="85" class="img-thumbnail" title="Xitefun Causal Wear Fancy Shoes" alt="Xitefun Causal Wear Fancy Shoes" src="image/catalog/demo/product/fashion/4.jpg">
									</a>
								</td>
								<td class="text-left"><a href="product.jsp">Xitefun Causal Wear Fancy Shoes</a>
								</td>
...
<div class="list-group">
	<ul class="list-item">
		...
		<li><a href="wishlist.jsp">Wish List</a>
		</li>
