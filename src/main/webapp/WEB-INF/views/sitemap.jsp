				...
				<div class="row">
					...
					<div class="col-md-5 col-sm-6">
						<ul class="simple-list arrow-list bold-list">
							...
							<li><a href="category.jsp">Watches</a>
								<ul>
									<li><a href="category.jsp">Men's Watches</a> </li>
									<li><a href="category.jsp">Women's Watches</a> </li>
									<li><a href="category.jsp">Kids' Watches</a> </li>
									<li><a href="category.jsp">Accessories</a> </li>
								</ul>
							</li>
						
							<li><a href="category.jsp">Health &amp; Beauty</a>
								<ul>
									<li><a href="category.jsp">Perfumes</a> </li>
									<li><a href="category.jsp">Makeup</a> </li>
									<li><a href="category.jsp">Sun Care</a> </li>
									<li><a href="category.jsp">Skin Care</a> </li>
									<li><a href="category.jsp">Eye Care</a> </li>
									<li><a href="category.jsp">Hair Care</a> </li>
								</ul>
							</li>
							<li><a href="category.jsp">Kids &amp; Babies</a>
								<ul>
									<li><a href="category.jsp">Toys</a> </li>
									<li><a href="category.jsp">Games</a>
										<ul>
											<li><a href="category.jsp">test 25</a>
											</li>
										</ul>
									</li>
									<li><a href="category.jsp">Puzzles</a> </li>
									<li><a href="category.jsp">Hobbies</a> </li>
									<li><a href="category.jsp">Strollers</a> </li>
									<li><a href="category.jsp">Health &amp; Safety</a> </li>
								</ul>
							</li>
							<li><a href="category.jsp">Sports</a>
								<ul>
									<li><a href="category.jsp">Cycling</a> </li>
									<li><a href="category.jsp">Running</a> </li>
									<li><a href="category.jsp">Swimming</a> </li>
									<li><a href="category.jsp">Football</a> </li>
									<li><a href="category.jsp">Golf</a> </li>
									<li><a href="category.jsp">Windsurfing</a> </li>
								</ul>
							</li>
							<li><a href="category.jsp">Home &amp; Garden</a>
								<ul>
									<li><a href="category.jsp">Bedding</a> </li>
									<li><a href="category.jsp">Food</a> </li>
									<li><a href="category.jsp">Furniture</a> </li>
									<li><a href="category.jsp">Kitchen</a> </li>
									<li><a href="category.jsp">Lighting</a> </li>
									<li><a href="category.jsp">Tools</a> </li>
								</ul>
							</li>
							<li><a href="category.jsp">Wines &amp; Spirits</a>
								<ul>
									<li><a href="category.jsp">Wine</a> </li>
									<li><a href="category.jsp">Whiskey</a> </li>
									<li><a href="category.jsp">Vodka</a> </li>
									<li><a href="category.jsp">Liqueurs</a> </li>
									<li><a href="category.jsp">Beer</a> </li>
								</ul>
							</li>
						</ul>
					</div>
					<div class="col-md-4 col-sm-6">
						<ul class="simple-list arrow-list bold-list">
							...
							<li><a href="my-account.jsp">My Account</a>
								<ul>
									<li><a href="order-history.jsp">Order History</a>
									</li>
									<li><a href="order-information.jsp">Order Information</a>
									</li>
									<li><a href="return.jsp">Return</a>
									</li>
									<li><a href="gift-voucher.jsp">Gift Voucher</a>
									</li>
								</ul>
							</li>
							<li><a href="cart.jsp">Shopping Cart</a>
							</li>
							<li><a href="checkout.jsp">Checkout</a>
							</li>
							<li><a href="http://demo.smartaddons.com/templates/html/supermarket/search.jsp">Search</a>
							</li>
							<li>Information
								<ul class="sitemap">
									...
									<li><a href="http://demo.smartaddons.com/templates/html/supermarket/elements.jsp">Elements</a>
									</li>
									<li><a href="http://demo.smartaddons.com/templates/html/supermarket/elements-forms.jsp">Forms</a>
									</li>
									<li><a href="http://demo.smartaddons.com/templates/html/supermarket/careers.jsp">Careers</a>
									</li>
									<li><a href="faq.jsp">Faq</a>
									</li>
									<li><a href="http://demo.smartaddons.com/templates/html/supermarket/404.jsp">404</a>
									</li>
